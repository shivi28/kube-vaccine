...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*Registration)(nil), (*v3.Registration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v2_Registration_To_v3_Registration(a.(*Registration), b.(*v3.Registration), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v3.Registration)(nil), (*Registration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v3_Registration_To_v2_Registration(a.(*v3.Registration), b.(*Registration), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*RegistrationList)(nil), (*v3.RegistrationList)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v2_RegistrationList_To_v3_RegistrationList(a.(*RegistrationList), b.(*v3.RegistrationList), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v3.RegistrationList)(nil), (*RegistrationList)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v3_RegistrationList_To_v2_RegistrationList(a.(*v3.RegistrationList), b.(*RegistrationList), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*RegistrationSpec)(nil), (*v3.RegistrationSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v2_RegistrationSpec_To_v3_RegistrationSpec(a.(*RegistrationSpec), b.(*v3.RegistrationSpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v3.RegistrationSpec)(nil), (*RegistrationSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v3_RegistrationSpec_To_v2_RegistrationSpec(a.(*v3.RegistrationSpec), b.(*RegistrationSpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*RegistrationStatus)(nil), (*v3.RegistrationStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v2_RegistrationStatus_To_v3_RegistrationStatus(a.(*RegistrationStatus), b.(*v3.RegistrationStatus), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v3.RegistrationStatus)(nil), (*RegistrationStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v3_RegistrationStatus_To_v2_RegistrationStatus(a.(*v3.RegistrationStatus), b.(*RegistrationStatus), scope)
	}); err != nil {
		return err
	}
	return nil
...
func autoConvert_v2_Registration_To_v3_Registration(in *Registration, out *v3.Registration, s conversion.Scope) error {
...
func Convert_v2_Registration_To_v3_Registration(in *Registration, out *v3.Registration, s conversion.Scope) error {
	return autoConvert_v2_Registration_To_v3_Registration(in, out, s)
}

func autoConvert_v3_Registration_To_v2_Registration(in *v3.Registration, out *Registration, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
...
func Convert_v3_Registration_To_v2_Registration(in *v3.Registration, out *Registration, s conversion.Scope) error {
	return autoConvert_v3_Registration_To_v2_Registration(in, out, s)
}

func autoConvert_v2_RegistrationList_To_v3_RegistrationList(in *RegistrationList, out *v3.RegistrationList, s conversion.Scope) error {
...
func Convert_v2_RegistrationList_To_v3_RegistrationList(in *RegistrationList, out *v3.RegistrationList, s conversion.Scope) error {
	return autoConvert_v2_RegistrationList_To_v3_RegistrationList(in, out, s)
}

func autoConvert_v3_RegistrationList_To_v2_RegistrationList(in *v3.RegistrationList, out *RegistrationList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	if in.Items != nil {
		in, out := &in.Items, &out.Items
...
func Convert_v3_RegistrationList_To_v2_RegistrationList(in *v3.RegistrationList, out *RegistrationList, s conversion.Scope) error {
	return autoConvert_v3_RegistrationList_To_v2_RegistrationList(in, out, s)
}

func autoConvert_v2_RegistrationSpec_To_v3_RegistrationSpec(in *RegistrationSpec, out *v3.RegistrationSpec, s conversion.Scope) error {
	out.Name = in.Name
...
func autoConvert_v3_RegistrationSpec_To_v2_RegistrationSpec(in *v3.RegistrationSpec, out *RegistrationSpec, s conversion.Scope) error {
	out.Name = in.Name
	out.VerifiedID = in.VerifiedID
...
func autoConvert_v2_RegistrationStatus_To_v3_RegistrationStatus(in *RegistrationStatus, out *v3.RegistrationStatus, s conversion.Scope) error {
	return nil
}

// Convert_v2_RegistrationStatus_To_v3_RegistrationStatus is an autogenerated conversion function.
func Convert_v2_RegistrationStatus_To_v3_RegistrationStatus(in *RegistrationStatus, out *v3.RegistrationStatus, s conversion.Scope) error {
	return autoConvert_v2_RegistrationStatus_To_v3_RegistrationStatus(in, out, s)
}

func autoConvert_v3_RegistrationStatus_To_v2_RegistrationStatus(in *v3.RegistrationStatus, out *RegistrationStatus, s conversion.Scope) error {
	return nil
}

// Convert_v3_RegistrationStatus_To_v2_RegistrationStatus is an autogenerated conversion function.
func Convert_v3_RegistrationStatus_To_v2_RegistrationStatus(in *v3.RegistrationStatus, out *RegistrationStatus, s conversion.Scope) error {
