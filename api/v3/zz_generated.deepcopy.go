...
func (in *RegistrationSpec) DeepCopyInto(out *RegistrationSpec) {
	*out = *in
	if in.VaccineDetails != nil {
		in, out := &in.VaccineDetails, &out.VaccineDetails
		*out = make([]*VaccineDetail, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(VaccineDetail)
				**out = **in
			}
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VaccineDetail) DeepCopyInto(out *VaccineDetail) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VaccineDetail.
func (in *VaccineDetail) DeepCopy() *VaccineDetail {
	if in == nil {
		return nil
	}
	out := new(VaccineDetail)
